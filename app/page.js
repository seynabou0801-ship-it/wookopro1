    ...
    <main className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white">
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-br from-[#25D366] to-green-600 text-white">
        <div className="max-w-4xl mx-auto px-6 sm:px-8 text-center">
          ...
          <a
            href={`https://wa.me/${(phone || '33777369462').replace(/[^0-9]/g, '')}?text=${encodeURIComponent("Bonjour WookoPRO, j'ai besoin d'une assistance rapide.")}`}
            target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8">
          ...
          <div className="pt-8 border-t flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              <a
                href={`https://wa.me/${(phone || '33777369462').replace(/[^0-9]/g, '')}?text=${encodeURIComponent("Bonjour WookoPRO, j'ai besoin du support.")}`}
                target="_blank"
                rel="noopener noreferrer"
