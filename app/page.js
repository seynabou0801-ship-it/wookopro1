    ...
    <main className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white">
      ...
      <header className={`border-b sticky top-0 bg-white/98 backdrop-blur-md z-40 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 h-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 sm:gap-8 ml-6">
            <Link
              href="/login"
              className="text-sm sm:text-base text-gray-700 hover:text-[#FF7A00] font-medium transition-colors hidden sm:inline-block"
            >
              Connexion
            </Link>
            ...
            <Link
              href="/provider/login"
              className="hidden md:inline-block text-sm sm:text-base text-gray-700 hover:text-[#FF7A00] font-medium transition-colors"
            >
              Prestataire
            </Link>
            ...
            <button
              ...
              className="bg-[#25D366] hover:bg-[#20BA5A] text-white px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl font-semibold text-sm sm:text-base flex items-center gap-2 shadow-lg hover:shadow-xl transition-all"
            >
